...
const TIERS = [
  {
    ...
    features: [
      { text: "1 free Reveal",                 included: true  },
      { text: "1024×1024 resolution",          included: true  },
      { text: "3 Reveals after sign-in",       included: true  },
      { text: "1280×1280 high resolution",     included: false },
      { text: "Commercial rights",             included: false },
      { text: "Credits never expire",          included: false },
    ] as Feature[],
  },
  {
    id: "crafter",
    ...
    features: [
      ...
      { text: "1280×1280 high resolution",     included: true },
